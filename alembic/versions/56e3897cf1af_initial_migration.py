...
def upgrade() -> None:
    ...
    protease_enum = sa.Enum(
        ...
        'elastase', 'proteinase_k', 'thermolysin',
        name='proteaseenum'
    )
    ...
    op.create_index(op.f('ix_digests_protein_id'), 'digests', ['protein_id'], unique=False)
    ...
    op.create_index(op.f('ix_peptides_digest_id'), 'peptides', ['digest_id'], unique=False)
